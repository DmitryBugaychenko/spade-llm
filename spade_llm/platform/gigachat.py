...
class GigaChatConfMixin:
    ...
    user: Optional[str] = Field(default=None, description="Username for authenticate")
    password: Optional[str] = Field(default=None, description="Password for authenticate")
...
class GigaChatModelConfig(GigaChatConfMixin, ChatModelConfiguration):
    """
...
class GigaChatEmbeddingsConf(GigaChatConfMixin, EmbeddingsModelConfiguration):
