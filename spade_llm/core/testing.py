...
class SimpleModelsProvider(ModelsProvider):
    ...
    def __init__(self, chat_models: Dict[str, BaseChatModel], embedding_models: Dict[str, Embeddings]):
...
class TestPlatform:
    ...
    def __init__(
        ...
        chat_models: Dict[str, BaseChatModel]  = None,
        embedding_models: Dict[str, Embeddings] = None,
    ):
        """
    ...
    def run_test(
        ...
        :param embedding_models: Dictionary mapping model names to embedding model instances.
        """
        asyncio.run(TestPlatform(agents, wait_for, chat_models, embedding_models).run())
